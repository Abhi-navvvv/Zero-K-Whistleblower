...
const paths: Record<string, IconDef> = {
  ...
  chat: "M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m0 14H6l-2 2V4h16z",
  shield:
    "M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5z",
  warning:
    "M1 21h22L12 2zm12-3h-2v-2h2zm0-4h-2v-4h2z",
  block:
    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2M4 12c0-4.42 3.58-8 8-8 1.85 0 3.55.63 4.9 1.69L5.69 16.9A7.902 7.902 0 0 1 4 12m8 8c-1.85 0-3.55-.63-4.9-1.69L18.31 7.1A7.902 7.902 0 0 1 20 12c0 4.42-3.58 8-8 8",
  how_to_vote:
    "M18 13h-5v5h-2v-5H6v-2h5V6h2v5h5v2zm-6-11C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z",
  gavel:
    "m15.727 10.625-2.355-2.354-8.374 8.374-.012 2.355 2.355.012 8.386-8.387zm1.414-1.413 1.414-1.414a1 1 0 0 0 0-1.414l-.94-.94a1 1 0 0 0-1.414 0l-1.414 1.414 2.354 2.354zM3 17.999l-.003 3 3 .001 9.795-9.795-2.998-2.998L3 18z",
  restart_alt:
    "M12 5V2L8 6l4 4V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z",
};
